...
sample = cv2.imread(
    "C:/Users/WA 52/Desktop/sample_data/SOCOFing/Altered/Altered-Hard/2__F_Left_index_finger_CR.BMP"
)

best_score = counter = 0
filename = image = kp1 = kp2 = mp = None
for file in os.listdir(
    "C:/Users/WA 52/Desktop/sample_data/SOCOFing/Real"
):
    if counter % 10 == 0:
        print(counter)
        print(file)
    ...
    fingerprint_img = cv2.imread(
        "C:/Users/WA 52/Desktop/sample_data/SOCOFing\Real/" + file
    )
